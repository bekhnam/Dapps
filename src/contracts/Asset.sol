...
contract Asset {
  ...
  enum STATUSES { CREATED, SENT, RECEIVED }

  event Action(string name, address account, address custodian, uint timestamp);
  ...
  function receive() public {
    ...
    // Log history
    emit Action("RECEIVED", msg.sender, msg.sender, now);
  }
}